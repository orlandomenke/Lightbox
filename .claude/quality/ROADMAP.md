...
- [ ] Guide sets exist to be made — a named set of guides, creatable and shared onto folders `evidence: GuideSetEditor, GuideSetTests, AGuideSetCanBeMadeAndNamed, ADeclaredGuideSetReachesTheDocumentsUnderItsFolder, ADocumentPullsASharedGuideSetIntoItsOwnGuides`
