...
- [ ] **B25** `P3` `brush` A simulated medium paints three to five times fainter than the same brush without one `evidence: manual`
  ...
  - Fix: conserve pigment through the lattice — what goes in comes out on the paper unless a wash was asked for. Worth doing before B24, because a rim on an invisible wash is invisible too. Cost: M
