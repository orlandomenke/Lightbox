...
492 files · 126441 lines · 2529 tests.
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` (9986 ln) · 4 test files
  - FrameCell:19, MainViewModel:62, LayerKindChoice:4432, TransformParts:6943
- `src/Lightbox.App/Views/MainWindow.axaml.cs` (4137 ln) · 16 test files
...
- `src/Lightbox.App/Rendering/CanvasControl.cs` (3209 ln) · 9 test files
  - CanvasControl:28, CanvasToolMode:743, GridGesture:800, TxDrag:947, DrawOp:2571
...
- `src/Lightbox.App/Services/AppSettings.cs` (196 ln) · 4 test files
  - AppSettings:16
- `src/Lightbox.App/Services/ExportRunner.cs` (196 ln) · 4 test files
...
- `src/Lightbox.Core/Documents/Symbol.cs` (185 ln) · 11 test files
