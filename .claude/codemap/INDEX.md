...
Generated from `5cc12f3` · 260 files · 63027 lines · 1184 tests.
...
- `src/Lightbox.Ai/AnthropicArtist.cs` (184 ln) · 58 indirect only
  - AnthropicArtist:18
...
- `src/Lightbox.Ai/Prompts.cs` (89 ln) · 1 test files
  - Prompts:11
- `src/Lightbox.Ai/ApiKeyProvider.cs` (81 ln) · 58 indirect only
  - ApiKeyProvider:10
...
- `src/Lightbox.App/Services/BrushPresets.cs` (271 ln) · 59 indirect only
...
- `src/Lightbox.App/Controls/ValueDrag.cs` (126 ln) · 58 indirect only
...
- `src/Lightbox.App/Rendering/CameraTransform.cs` (95 ln) · 1 test files
  - CameraTransform:16
- `src/Lightbox.App/Services/AutosaveService.cs` (85 ln) · 58 indirect only
  - AutosaveService:22
...
- `src/Lightbox.App/Rendering/ThumbnailRenderer.cs` (60 ln) · 58 indirect only
  - ThumbnailRenderer:7
- `src/Lightbox.App/Input/StrokeBuilder.cs` (58 ln) · 58 indirect only
  - StrokeBuilder:10
...
- `src/Lightbox.Core/Projects/ProjectIo.cs` (758 ln) · 7 test files
...
- `src/Lightbox.Core/Documents/Symbol.cs` (179 ln) · 1 test files
...
- `src/Lightbox.Core/Documents/Stroke.cs` (81 ln) · 41 test files
  - Stroke:9
...
- `src/Lightbox.Core/Serialization/FrameConverter.cs` (73 ln) · 62 indirect only
  - FrameConverter:14
- `src/Lightbox.Core/Serialization/DocJson.cs` (66 ln) · 15 test files
  - DocJson:11
- `src/Lightbox.Core/Documents/Doc.cs` (63 ln) · 15 test files
  - Doc:8, ClipRegion:57
- `src/Lightbox.Core/Documents/Frame.cs` (62 ln) · 58 test files
