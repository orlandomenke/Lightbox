...
- `src/Lightbox.Ai/AnthropicArtist.cs` (184 ln) · 44 indirect only
  - AnthropicArtist:18
...
- `src/Lightbox.Ai/Prompts.cs` (89 ln) · 1 test files
  - Prompts:11
- `src/Lightbox.Ai/ApiKeyProvider.cs` (81 ln) · 44 indirect only
  - ApiKeyProvider:10
...
- `src/Lightbox.App/ViewModels/WorkspaceViewModel.cs` (316 ln) · 1 test files
  - WorkspaceViewModel:20, WorkspaceRow:311
...
- `src/Lightbox.App/Docking/DockLayout.cs` (241 ln) · 3 test files
...
- `src/Lightbox.App/Controls/TimelineRuler.cs` (181 ln) · **no tests**
  - TimelineRuler:17
- `src/Lightbox.App/Services/PerformanceMonitor.cs` (180 ln) · 44 indirect only
...
- `src/Lightbox.App/Controls/DockStrip.cs` (132 ln) · 1 test files
  - DockStrip:24
- `src/Lightbox.App/Controls/ValueDrag.cs` (126 ln) · 44 indirect only
...
- `src/Lightbox.App/Services/AppSettings.cs` (102 ln) · 44 indirect only
  - AppSettings:15
- `src/Lightbox.App/Controls/DockDropIndicator.cs` (101 ln) · **no tests**
  - DockDropIndicator:23
- `src/Lightbox.App/Docking/DockPanels.cs` (101 ln) · 4 test files
...
- `src/Lightbox.App/Rendering/CameraTransform.cs` (95 ln) · 1 test files
  - CameraTransform:16
- `src/Lightbox.App/Services/AutosaveService.cs` (85 ln) · 44 indirect only
  - AutosaveService:22
...
- `src/Lightbox.App/Services/SequenceExporter.cs` (62 ln) · 2 test files
  - SequenceExporter:20
- `src/Lightbox.App/Rendering/ThumbnailRenderer.cs` (60 ln) · 44 indirect only
  - ThumbnailRenderer:7
- `src/Lightbox.App/Input/StrokeBuilder.cs` (58 ln) · 44 indirect only
  - StrokeBuilder:10
...
- `src/Lightbox.App/Rendering/RenderSnapshot.cs` (24 ln) · 12 test files
  - RenderSnapshot:16
- `src/Lightbox.App/App.axaml.cs` (20 ln) · 70 indirect only
  - App:8
...
- `src/Lightbox.Core/Documents/Pivot.cs` (16 ln) · 2 test files
  - Pivot:7
- `src/Lightbox.Core/Documents/Ids.cs` (14 ln) · 81 indirect only
  - Ids:3
