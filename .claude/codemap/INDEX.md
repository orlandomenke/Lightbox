...
524 files · 134652 lines · 2701 tests.
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` (10451 ln) · 4 test files
  - FrameCell:19, MainViewModel:62, LayerKindChoice:4509, TransformParts:7177
- `src/Lightbox.App/Views/MainWindow.axaml.cs` (4398 ln) · 19 test files
  - MainWindow:19, UnsavedChoice:2840
- `src/Lightbox.App/Views/MainWindow.axaml` (3542 ln) · **no tests**
...
- `src/Lightbox.App/Rendering/CanvasControl.cs` (3488 ln) · 11 test files
