...
308 files · 75125 lines · 1444 tests.
...
- `src/Lightbox.App/Views/MainWindow.axaml.cs` (3046 ln) · 6 test files
  - MainWindow:17
- `src/Lightbox.App/Views/MainWindow.axaml` (2701 ln) · **no tests**
...
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` (323 ln) · 57 test files
...
- `src/Lightbox.App/App.axaml.cs` (25 ln) · 61 indirect only
  - App:8
...
- `tools/Lightbox.Bench/AnimationSweeps.cs` (358 ln) · **no tests**
...
- `tools/Lightbox.Bench/DrawingSweeps.cs` (215 ln) · 4 test files
...
- `src/Lightbox.Core/Timeline/StripSlicer.cs` (405 ln) · 2 test files
  - StripSlicer:49
- `src/Lightbox.Core/Documents/BrushSettings.cs` (300 ln) · 43 test files
...
- `src/Lightbox.Core/Documents/MediumSettings.cs` (191 ln) · 12 test files
...
- `src/Lightbox.Core/Documents/Stroke.cs` (129 ln) · 56 test files
...
- `src/Lightbox.Core/Documents/DocumentFactory.cs` (103 ln) · 29 test files
  - DocumentFactory:3
...
- `src/Lightbox.Core/Geometry/ColorOps.cs` (29 ln) · 1 test files
  - ColorOps:3
- `src/Lightbox.Core/Documents/ToolKind.cs` (23 ln) · 46 test files
  - ToolKind:3
...
- `src/Lightbox.Core/Documents/Pivot.cs` (16 ln) · 2 test files
  - Pivot:7
- `src/Lightbox.Core/Documents/Ids.cs` (14 ln) · 104 indirect only
  - Ids:3
...
- `src/Lightbox.Raster/BrushEngine.cs` (1425 ln) · 14 test files
  - BrushEngine:25
...
- `src/Lightbox.Raster/Media/PigmentModel.cs` (356 ln) · 3 test files
  - Pigment:31
- `src/Lightbox.Raster/Media/MediumSimulator.cs` (314 ln) · 1 test files
  - MediumSimulator:22
