...
388 files · 96238 lines · 1968 tests.
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` (8858 ln) · 4 test files
  - FrameCell:19, MainViewModel:62, LayerKindChoice:3928, TransformParts:5871
- `src/Lightbox.App/Views/MainWindow.axaml.cs` (3548 ln) · 6 test files
  - MainWindow:18
- `src/Lightbox.App/Views/MainWindow.axaml` (3037 ln) · **no tests**
...
- `src/Lightbox.App/ViewModels/MainViewModel.Symbols.cs` (858 ln) · 76 test files
  - MainViewModel:20
- `src/Lightbox.App/ViewModels/PaletteDockerViewModel.cs` (816 ln) · 1 test files
  - SwatchRow:15, PaletteDockerViewModel:93
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` (811 ln) · 76 test files
...
- `src/Lightbox.App/Views/ConfigureWindow.axaml.cs` (789 ln) · 1 test files
...
- `src/Lightbox.App/Services/UnityExporter.cs` (648 ln) · 7 test files
...
- `src/Lightbox.App/Views/ExportWindow.axaml.cs` (274 ln) · 1 test files
  - ExportWindow:33
...
- `src/Lightbox.App/ViewModels/SymbolBrowserViewModel.cs` (261 ln) · 76 indirect only
...
- `src/Lightbox.App/Services/AppSettings.cs` (196 ln) · 3 test files
  - AppSettings:16
...
- `src/Lightbox.App/Services/ExportPreset.cs` (147 ln) · 2 test files
  - ExportTarget:6, ExportPreset:48
...
- `src/Lightbox.App/Services/ExportRunner.cs` (118 ln) · 1 test files
  - ExportRun:16, ExportRunner:41
- `src/Lightbox.App/ViewModels/DocumentTab.cs` (118 ln) · 19 test files
...
- `src/Lightbox.App/Services/StrokeStabilizer.cs` (105 ln) · 1 test files
  - StrokeStabilizer:13
- `src/Lightbox.App/Services/ExportPresetStore.cs` (102 ln) · 3 test files
  - ExportPresetStore:24, State:40
...
- `src/Lightbox.App/Views/ExportWindow.axaml` (83 ln) · **no tests**
  - BackgroundBox, BackgroundHint, BackgroundLabel, DeletePresetButton, EnginePanel, PackBox, PackLabel, PaddingBox …
...
- `tools/Lightbox.Bench/AnimationSweeps.cs` (358 ln) · 2 test files
...
- `src/Lightbox.Core/Documents/BrushSettings.cs` (421 ln) · 65 test files
...
- `src/Lightbox.Core/Documents/Scene.cs` (306 ln) · 12 test files
...
- `src/Lightbox.Core/Projects/ProjectManifest.cs` (288 ln) · 15 test files
...
- `src/Lightbox.Core/Timeline/FigureFinder.cs` (206 ln) · 1 test files
  - FigureFinder:43
- `src/Lightbox.Core/Export/BackgroundRules.cs` (198 ln) · 4 test files
...
- `src/Lightbox.Core/Documents/Symbol.cs` (179 ln) · 10 test files
...
- `src/Lightbox.Core/Documents/CollisionShapes.cs` (157 ln) · 3 test files
  - CollisionShapes:21
...
- `src/Lightbox.Core/Documents/Doc.cs` (152 ln) · 29 test files
...
- `src/Lightbox.Core/Documents/Anchors.cs` (144 ln) · 4 test files
  - Anchors:13
- `src/Lightbox.Core/Documents/Palette.cs` (144 ln) · 14 test files
  - Swatch:8, Palette:30, GimpPalette:55
- `src/Lightbox.Core/Documents/Layer.cs` (143 ln) · 33 test files
  - LayerKind:5, LayerBlendMode:16, Cel:40, LayerGroup:51, Layer:69
- `src/Lightbox.Core/Export/UnityConvert.cs` (138 ln) · 1 test files
  - UnityConvert:34
- `src/Lightbox.Core/Documents/Stroke.cs` (129 ln) · 79 test files
  - Stroke:9, BakedSample:121
- `src/Lightbox.Core/Timeline/ExposureSheet.cs` (125 ln) · 3 test files
  - ExposureSheet:8
...
- `src/Lightbox.Core/Documents/DocumentFactory.cs` (103 ln) · 35 test files
  - DocumentFactory:3
- `src/Lightbox.Core/Documents/CollisionShape.cs` (101 ln) · 3 test files
  - ShapeRole:13, CollisionShape:67, ShapeBox:87
- `src/Lightbox.Core/Timeline/TimingPreset.cs` (101 ln) · 2 test files
  - TimingPreset:34
...
- `src/Lightbox.Core/Documents/Frame.cs` (92 ln) · 83 test files
  - FrameRole:8, Frame:19, VectorFrame:57, PaintedFrame:70
- `src/Lightbox.Core/Projects/AssetStatus.cs` (91 ln) · 2 test files
...
- `src/Lightbox.Core/Serialization/DocJson.cs` (77 ln) · 25 test files
  - DocJson:11
- `src/Lightbox.Core/Inbetween/StrokeMatcher.cs` (73 ln) · 1 test files
  - StrokePair:6, StrokeMatcher:13
- `src/Lightbox.Core/Documents/Anchor.cs` (70 ln) · 5 test files
...
- `src/Lightbox.Core/Geometry/ColorOps.cs` (29 ln) · 1 test files
  - ColorOps:3
- `src/Lightbox.Core/Documents/ToolKind.cs` (23 ln) · 61 test files
  - ToolKind:3
- `src/Lightbox.Core/Inbetween/Easing.cs` (20 ln) · 9 test files
  - Easing:3, EasingOps:11
- `src/Lightbox.Core/Documents/Pivot.cs` (16 ln) · 3 test files
  - Pivot:7
- `src/Lightbox.Core/Documents/Ids.cs` (14 ln) · 149 indirect only
  - Ids:3
...
- `src/Lightbox.Raster/BrushEngine.cs` (1707 ln) · 19 test files
  - BrushEngine:25
...
- `src/Lightbox.Raster/Media/MediumSimulator.cs` (341 ln) · 3 test files
  - MediumSimulator:22
- `src/Lightbox.Raster/SymbolRasterizer.cs` (305 ln) · 3 test files
...
- `src/Lightbox.Raster/BlendModes.cs` (49 ln) · 25 indirect only
  - BlendModes:15
