...
Generated from `e8f7005` · 264 files · 63944 lines · 1206 tests.
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` (7385 ln) · 59 test files
  - FrameCell:19, MainViewModel:62, LayerKindChoice:3002, TransformParts:4731
...
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` (323 ln) · 38 test files
...
- `src/Lightbox.App/App.axaml.cs` (25 ln) · 88 indirect only
  - App:8
...
- `src/Lightbox.Core/Projects/ProjectIo.cs` (758 ln) · 8 test files
...
- `src/Lightbox.Core/Timeline/StripSlicer.cs` (405 ln) · 2 test files
  - StripSlicer:49
- `src/Lightbox.Core/Documents/BrushSettings.cs` (242 ln) · 27 test files
...
- `src/Lightbox.Core/Documents/Symbol.cs` (179 ln) · 3 test files
...
- `src/Lightbox.Core/Documents/Stroke.cs` (81 ln) · 42 test files
  - Stroke:9
...
- `src/Lightbox.Core/Serialization/FrameConverter.cs` (73 ln) · 63 indirect only
  - FrameConverter:14
- `src/Lightbox.Core/Serialization/DocJson.cs` (66 ln) · 15 test files
  - DocJson:11
- `src/Lightbox.Core/Documents/Doc.cs` (63 ln) · 15 test files
  - Doc:8, ClipRegion:57
- `src/Lightbox.Core/Documents/Frame.cs` (62 ln) · 59 test files
...
- `src/Lightbox.Core/Geometry/ColorOps.cs` (29 ln) · 1 test files
  - ColorOps:3
- `src/Lightbox.Core/Documents/ToolKind.cs` (23 ln) · 33 test files
  - ToolKind:3
...
- `src/Lightbox.Core/Documents/Pivot.cs` (16 ln) · 2 test files
  - Pivot:7
- `src/Lightbox.Core/Documents/Ids.cs` (14 ln) · 102 indirect only
  - Ids:3
...
- `src/Lightbox.Raster/FrameRasterizer.cs` (114 ln) · 13 test files
  - FrameRasterizer:10
- `src/Lightbox.Raster/SymbolRegistry.cs` (95 ln) · 2 test files
  - SymbolRegistry:24
