...
2946 tests, derived from the suite itself. Each line is a
...
- The Index Keeps Unclamped Bounds For Picking — `:158`
- Negative Coordinates Index And Query The Same As Positive Ones — `:183`
- ATile Sized Query Touches AFraction Of ABusy Drawing — `:207`

## StrokePickerTests
`tests/Lightbox.Raster.Tests/StrokePickerTests.cs`

- The Stroke On Top Is The Picked One — `:58`
- An Eraser Does Not Steal AClick From Ink Under It — `:75`
- An Eraser With Nothing Under It Is Still Picked — `:92`
- AClick Beside The Line Picks Nothing — `:107`
- AWide Stroke Is Wide To Hit — `:126`
- AFill Is Picked From The Inside — `:146`
- AHole In AFill Is Not Part Of It — `:160`
- AGradient Is Picked By Its Axis Rather Than Its Coverage — `:187`
- AMarquee Catches What It Touches Rather Than Only What It Encloses — `:210`
- AMarquee Returns Record Order — `:231`
- AZero Area Marquee Catches Nothing — `:251`
- Bounds Are Narrowed By Geometry Rather Than Trusted — `:268`
- AStroke Outside The Document Is Still Pickable — `:300`
