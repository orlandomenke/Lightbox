...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.61 | 0.61 | 24 | 7 | 1 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 25 | 5 | 0 | 0 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.21 | 0.43 | 17 | 4 | 3 | 2 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.82 | 28 | 5 | 30 | 26 |
| `src/Lightbox.App/Rendering/SceneRenderer.cs` | 0.09 | 0.19 | 7 | 2 | 4 | 2 |
| `src/Lightbox.App/ViewModels/LayerRow.cs` | 0.09 | 0.12 | 5 | 1 | 4 | 1 |
| `src/Lightbox.App/Services/BrushPresets.cs` | 0.09 | 0.12 | 5 | 1 | 2 | 0 |
...
| `src/Lightbox.Raster/BrushEngine.cs` | 0.06 | 0.26 | 12 | 1 | 10 | 6 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.82, 28 commits (5 fixes), 30 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.61, 24 commits (7 fixes), 1 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 25 commits (5 fixes), 0 dependents
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.43, 17 commits (4 fixes), 3 dependents
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.27, 2 commits (0 fixes), 49 dependents
- `src/Lightbox.Raster/BrushEngine.cs` — heat 0.26, 12 commits (1 fixes), 10 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.25, 3 commits (0 fixes), 43 dependents
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.23, 5 commits (1 fixes), 24 dependents
