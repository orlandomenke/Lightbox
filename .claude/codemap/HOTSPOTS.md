...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.64 | 0.64 | 23 | 7 | 1 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 22 | 5 | 0 | 0 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.22 | 0.44 | 15 | 4 | 3 | 2 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.81 | 24 | 5 | 27 | 23 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.81, 24 commits (5 fixes), 27 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.64, 23 commits (7 fixes), 1 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 22 commits (5 fixes), 0 dependents
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.44, 15 commits (4 fixes), 3 dependents
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.28, 2 commits (0 fixes), 45 dependents
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.23, 5 commits (1 fixes), 21 dependents
- `src/Lightbox.Raster/BrushEngine.cs` — heat 0.23, 9 commits (1 fixes), 7 dependents
...
- `src/Lightbox.App/Views/MainWindow.axaml` (1292 ln)
