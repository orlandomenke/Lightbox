...
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.92 | 39 | 7 | 45 | 39 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.11 | 0.46 | 22 | 5 | 6 | 5 |
...
| `src/Lightbox.Core/Documents/Stroke.cs` | 0.06 | 0.26 | 4 | 0 | 60 | 38 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.92, 39 commits (7 fixes), 45 dependents
...
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.46, 22 commits (5 fixes), 6 dependents
...
- `src/Lightbox.App/Views/MainWindow.axaml` (1769 ln)
- `src/Lightbox.App/Views/MainWindow.axaml.cs` (1262 ln)
