...
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.52 | 0.52 | 30 | 5 | 0 | 0 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.22 | 0.88 | 36 | 6 | 40 | 35 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.12 | 0.47 | 22 | 5 | 5 | 4 |
| `src/Lightbox.Raster/BrushEngine.cs` | 0.09 | 0.37 | 18 | 3 | 13 | 9 |
| `src/Lightbox.App/Services/BrushPresets.cs` | 0.09 | 0.11 | 6 | 1 | 3 | 0 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.88, 36 commits (6 fixes), 40 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.57, 28 commits (7 fixes), 1 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.52, 30 commits (5 fixes), 0 dependents
...
- `src/Lightbox.Core/Timeline/DocumentEditor.cs` — heat 0.19, 8 commits (2 fixes), 6 dependents
