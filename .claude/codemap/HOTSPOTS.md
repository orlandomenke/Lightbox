...
| `src/Lightbox.Core/Documents/Frame.cs` | 0.07 | 0.26 | 2 | 0 | 82 | 58 |
...
| `src/Lightbox.Core/Documents/Stroke.cs` | 0.05 | 0.21 | 4 | 0 | 63 | 41 |
...
| `src/Lightbox.App/Services/SpriteSheetExporter.cs` | 0.05 | 0.20 | 1 | 0 | 62 | 37 |
...
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.26, 2 commits (0 fixes), 82 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.21, 4 commits (0 fixes), 63 dependents
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` — heat 0.20, 1 commits (0 fixes), 62 dependents
- `src/Lightbox.Core/Documents/Scene.cs` — heat 0.20, 11 commits (2 fixes), 22 dependents
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.18, 7 commits (1 fixes), 35 dependents
