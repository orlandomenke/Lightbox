...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 42 | 5 | 0 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.31 | 0.62 | 40 | 7 | 3 | 2 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.93 | 46 | 7 | 52 | 45 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.11 | 0.44 | 24 | 5 | 6 | 5 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.93, 46 commits (7 fixes), 52 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.62, 40 commits (7 fixes), 3 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 42 commits (5 fixes), 0 dependents
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.44, 24 commits (5 fixes), 6 dependents
...
- `src/Lightbox.App/Views/MainWindow.axaml` (2275 ln)
...
- `src/Lightbox.App/App.axaml` (120 ln)
