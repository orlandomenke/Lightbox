...
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.21 | 0.43 | 18 | 4 | 3 | 2 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.81 | 29 | 5 | 30 | 26 |
...
| `src/Lightbox.Raster/BrushEngine.cs` | 0.07 | 0.27 | 13 | 1 | 11 | 7 |
...
| `src/Lightbox.Core/Documents/BrushSettings.cs` | 0.06 | 0.24 | 6 | 1 | 25 | 16 |

## Most active regardless of coverage

- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.81, 29 commits (5 fixes), 30 dependents
...
- `src/Lightbox.Raster/BrushEngine.cs` — heat 0.27, 13 commits (1 fixes), 11 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.26, 3 commits (0 fixes), 45 dependents
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.24, 6 commits (1 fixes), 25 dependents
