...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.59 | 0.59 | 25 | 7 | 1 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.53 | 0.53 | 27 | 5 | 0 | 0 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.21 | 0.43 | 19 | 4 | 3 | 2 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.81 | 31 | 5 | 30 | 26 |
...
| `src/Lightbox.Raster/BrushEngine.cs` | 0.08 | 0.32 | 15 | 2 | 11 | 7 |
...
| `src/Lightbox.Core/Documents/BrushSettings.cs` | 0.06 | 0.24 | 7 | 1 | 25 | 16 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.81, 31 commits (5 fixes), 30 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.59, 25 commits (7 fixes), 1 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.53, 27 commits (5 fixes), 0 dependents
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.43, 19 commits (4 fixes), 3 dependents
- `src/Lightbox.Raster/BrushEngine.cs` — heat 0.32, 15 commits (2 fixes), 11 dependents
...
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.24, 7 commits (1 fixes), 25 dependents
- `src/Lightbox.Core/Timeline/DocumentEditor.cs` — heat 0.21, 8 commits (2 fixes), 6 dependents
