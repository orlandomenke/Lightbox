...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 46 | 5 | 0 | 0 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.94 | 51 | 7 | 56 | 49 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.16 | 0.63 | 44 | 7 | 5 | 4 |
...
| `src/Lightbox.App/Rendering/SceneRenderer.cs` | 0.05 | 0.19 | 13 | 2 | 7 | 4 |

## Most active regardless of coverage

- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.94, 51 commits (7 fixes), 56 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.63, 44 commits (7 fixes), 5 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 46 commits (5 fixes), 0 dependents
...
- `src/Lightbox.App/Rendering/SceneRenderer.cs` — heat 0.19, 13 commits (2 fixes), 7 dependents
