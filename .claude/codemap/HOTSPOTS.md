...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.58 | 0.58 | 26 | 7 | 1 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.52 | 0.52 | 28 | 5 | 0 | 0 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.82 | 33 | 5 | 35 | 31 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.11 | 0.43 | 20 | 4 | 5 | 4 |
...
| `src/Lightbox.Raster/BrushEngine.cs` | 0.08 | 0.32 | 16 | 2 | 12 | 8 |
...
| `src/Lightbox.Core/Documents/Stroke.cs` | 0.06 | 0.25 | 3 | 0 | 50 | 29 |
| `src/Lightbox.Core/Documents/BrushSettings.cs` | 0.06 | 0.25 | 7 | 1 | 30 | 21 |
| `src/Lightbox.App/ViewModels/ColorPickerViewModel.cs` | 0.06 | 0.08 | 2 | 1 | 2 | 1 |
| `src/Lightbox.App/Rendering/SceneRenderer.cs` | 0.05 | 0.22 | 10 | 2 | 7 | 4 |
| `src/Lightbox.App/Views/NewDocumentDialog.axaml` | 0.05 | 0.05 | 1 | 1 | 0 | 0 |

## Most active regardless of coverage

- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.82, 33 commits (5 fixes), 35 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.58, 26 commits (7 fixes), 1 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.52, 28 commits (5 fixes), 0 dependents
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.43, 20 commits (4 fixes), 5 dependents
- `src/Lightbox.Raster/BrushEngine.cs` — heat 0.32, 16 commits (2 fixes), 12 dependents
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.27, 2 commits (0 fixes), 57 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.25, 3 commits (0 fixes), 50 dependents
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.25, 7 commits (1 fixes), 30 dependents
- `src/Lightbox.App/Rendering/SceneRenderer.cs` — heat 0.22, 10 commits (2 fixes), 7 dependents
