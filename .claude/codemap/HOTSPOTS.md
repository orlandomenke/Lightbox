...
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.81 | 26 | 5 | 28 | 24 |
| `src/Lightbox.App/Rendering/SceneRenderer.cs` | 0.13 | 0.18 | 6 | 2 | 3 | 1 |
...
| `src/Lightbox.Core/Documents/Scene.cs` | 0.08 | 0.15 | 5 | 1 | 9 | 2 |
...
| `src/Lightbox.Core/Documents/Stroke.cs` | 0.06 | 0.24 | 3 | 0 | 38 | 19 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.81, 26 commits (5 fixes), 28 dependents
...
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.24, 3 commits (0 fixes), 38 dependents
