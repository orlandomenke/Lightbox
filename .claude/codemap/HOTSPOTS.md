...
| `src/Lightbox.App/Services/BrushPresets.cs` | 0.07 | 0.10 | 3 | 1 | 1 | 0 |
...
- `src/Lightbox.App/Views/MainWindow.axaml` (1289 ln)
- `src/Lightbox.App/Views/MainWindow.axaml.cs` (1072 ln)
