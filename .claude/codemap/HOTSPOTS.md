...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.55 | 0.55 | 55 | 6 | 0 | 0 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.24 | 0.95 | 61 | 8 | 65 | 58 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.15 | 0.60 | 52 | 7 | 7 | 6 |
...
| `src/Lightbox.App/Services/SpriteSheetExporter.cs` | 0.05 | 0.21 | 1 | 0 | 62 | 37 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.95, 61 commits (8 fixes), 65 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.60, 52 commits (7 fixes), 7 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.55, 55 commits (6 fixes), 0 dependents
...
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` — heat 0.21, 1 commits (0 fixes), 62 dependents
