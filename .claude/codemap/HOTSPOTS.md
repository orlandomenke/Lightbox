...
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.38 | 0.76 | 65 | 8 | 5 | 2 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.15 | 0.58 | 53 | 7 | 7 | 6 |
...
| `src/Lightbox.App/ViewModels/MainViewModel.Symbols.cs` | 0.05 | 0.21 | 1 | 0 | 70 | 62 |
...
| `src/Lightbox.App/Services/SpriteSheetExporter.cs` | 0.05 | 0.20 | 2 | 0 | 68 | 42 |
| `src/Lightbox.Core/Documents/Scene.cs` | 0.05 | 0.19 | 11 | 2 | 23 | 7 |
| `src/Lightbox.Core/Documents/BrushSettings.cs` | 0.05 | 0.19 | 7 | 1 | 40 | 31 |

## Most active regardless of coverage

- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.76, 65 commits (8 fixes), 5 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.58, 53 commits (7 fixes), 7 dependents
...
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.27, 3 commits (0 fixes), 90 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.22, 5 commits (0 fixes), 69 dependents
- `src/Lightbox.App/ViewModels/MainViewModel.Symbols.cs` — heat 0.21, 1 commits (0 fixes), 70 dependents
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` — heat 0.20, 2 commits (0 fixes), 68 dependents
- `src/Lightbox.Core/Documents/Scene.cs` — heat 0.19, 11 commits (2 fixes), 23 dependents

## Substantial files with no test reference

- `src/Lightbox.App/Views/MainWindow.axaml` (2655 ln)
