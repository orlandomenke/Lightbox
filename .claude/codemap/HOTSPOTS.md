...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.53 | 0.53 | 38 | 5 | 0 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.46 | 0.61 | 37 | 7 | 2 | 1 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.93 | 44 | 7 | 49 | 42 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.11 | 0.44 | 23 | 5 | 6 | 5 |
| `src/Lightbox.App/App.axaml` | 0.09 | 0.09 | 7 | 1 | 0 | 0 |
| `src/Lightbox.Raster/BrushEngine.cs` | 0.08 | 0.34 | 18 | 3 | 14 | 10 |
...
| `src/Lightbox.Core/Documents/Frame.cs` | 0.07 | 0.26 | 2 | 0 | 69 | 48 |
...
| `src/Lightbox.Core/Documents/BrushSettings.cs` | 0.06 | 0.22 | 7 | 1 | 35 | 26 |
| `src/Lightbox.Core/Documents/Scene.cs` | 0.05 | 0.20 | 8 | 2 | 16 | 5 |

## Most active regardless of coverage

- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.93, 44 commits (7 fixes), 49 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.61, 37 commits (7 fixes), 2 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.53, 38 commits (5 fixes), 0 dependents
...
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.26, 2 commits (0 fixes), 69 dependents
...
- `src/Lightbox.App/Rendering/SceneRenderer.cs` — heat 0.20, 11 commits (2 fixes), 7 dependents

## Substantial files with no test reference

- `src/Lightbox.App/Views/MainWindow.axaml` (2018 ln)
