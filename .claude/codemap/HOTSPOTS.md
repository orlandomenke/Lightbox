...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 57 | 6 | 0 | 0 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.38 | 0.76 | 66 | 8 | 5 | 2 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.15 | 0.59 | 54 | 7 | 7 | 6 |
...
| `src/Lightbox.App/ViewModels/MainViewModel.Symbols.cs` | 0.05 | 0.22 | 2 | 0 | 71 | 63 |
...
| `src/Lightbox.App/Services/SpriteSheetExporter.cs` | 0.05 | 0.21 | 2 | 0 | 69 | 43 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.76, 66 commits (8 fixes), 5 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.59, 54 commits (7 fixes), 7 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 57 commits (6 fixes), 0 dependents
...
- `src/Lightbox.App/ViewModels/MainViewModel.Symbols.cs` — heat 0.22, 2 commits (0 fixes), 71 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.22, 5 commits (0 fixes), 70 dependents
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` — heat 0.21, 2 commits (0 fixes), 69 dependents
- `src/Lightbox.Core/Documents/Scene.cs` — heat 0.19, 11 commits (2 fixes), 23 dependents

## Substantial files with no test reference

- `src/Lightbox.App/Views/MainWindow.axaml` (2661 ln)
