...
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.20 | 0.80 | 32 | 5 | 31 | 27 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.80, 32 commits (5 fixes), 31 dependents
