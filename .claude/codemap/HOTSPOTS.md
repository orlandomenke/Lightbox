...
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.24 | 0.94 | 62 | 8 | 66 | 59 |
...
| `src/Lightbox.Core/Documents/Frame.cs` | 0.07 | 0.27 | 3 | 0 | 85 | 60 |
...
| `src/Lightbox.Core/Documents/Stroke.cs` | 0.05 | 0.21 | 4 | 0 | 65 | 43 |
| `src/Lightbox.App/Views/NewDocumentDialog.axaml` | 0.05 | 0.05 | 3 | 1 | 0 | 0 |
| `src/Lightbox.App/Services/SpriteSheetExporter.cs` | 0.05 | 0.21 | 2 | 0 | 65 | 39 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.94, 62 commits (8 fixes), 66 dependents
...
- `src/Lightbox.Core/Documents/Frame.cs` — heat 0.27, 3 commits (0 fixes), 85 dependents
- `src/Lightbox.Core/Documents/Stroke.cs` — heat 0.21, 4 commits (0 fixes), 65 dependents
- `src/Lightbox.App/Services/SpriteSheetExporter.cs` — heat 0.21, 2 commits (0 fixes), 65 dependents
- `src/Lightbox.Core/Documents/Scene.cs` — heat 0.20, 11 commits (2 fixes), 22 dependents
- `src/Lightbox.Core/Documents/BrushSettings.cs` — heat 0.19, 7 commits (1 fixes), 37 dependents
