...
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.94 | 52 | 7 | 56 | 49 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.16 | 0.63 | 45 | 7 | 5 | 4 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.10 | 0.42 | 24 | 5 | 6 | 5 |
| `src/Lightbox.App/App.axaml` | 0.10 | 0.10 | 9 | 1 | 0 | 0 |
| `src/Lightbox.Raster/BrushEngine.cs` | 0.08 | 0.32 | 19 | 3 | 14 | 10 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.94, 52 commits (7 fixes), 56 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.63, 45 commits (7 fixes), 5 dependents
...
- `src/Lightbox.Raster/BrushEngine.cs` — heat 0.32, 19 commits (3 fixes), 14 dependents
...
- `src/Lightbox.App/Views/MainWindow.axaml` (2372 ln)
...
- `src/Lightbox.App/Styles/ColorPicker.axaml` (147 ln)
