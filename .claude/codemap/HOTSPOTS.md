...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 41 | 5 | 0 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.46 | 0.61 | 39 | 7 | 2 | 1 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.92 | 46 | 7 | 51 | 44 |
...
- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.92, 46 commits (7 fixes), 51 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.61, 39 commits (7 fixes), 2 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 41 commits (5 fixes), 0 dependents
...
- `src/Lightbox.App/Views/MainWindow.axaml` (2227 ln)
