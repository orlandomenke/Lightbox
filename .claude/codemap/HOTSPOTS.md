...
| --- | --- | --- | --- | --- | --- | --- |
| `src/Lightbox.App/Views/MainWindow.axaml` | 0.54 | 0.54 | 40 | 5 | 0 | 0 |
| `src/Lightbox.App/Views/MainWindow.axaml.cs` | 0.45 | 0.61 | 38 | 7 | 2 | 1 |
| `src/Lightbox.App/ViewModels/MainViewModel.cs` | 0.23 | 0.92 | 45 | 7 | 51 | 44 |
| `src/Lightbox.App/Rendering/CanvasControl.cs` | 0.11 | 0.43 | 23 | 5 | 6 | 5 |
...
| `src/Lightbox.Raster/Media/PigmentModel.cs` | 0.06 | 0.09 | 3 | 1 | 4 | 1 |
...
| `src/Lightbox.App/Services/IpcDocumentApi.cs` | 0.06 | 0.07 | 3 | 1 | 2 | 1 |
| `src/Lightbox.Core/Documents/BrushSettings.cs` | 0.05 | 0.21 | 7 | 1 | 35 | 26 |
| `src/Lightbox.Core/Documents/Scene.cs` | 0.05 | 0.21 | 9 | 2 | 17 | 5 |

## Most active regardless of coverage

- `src/Lightbox.App/ViewModels/MainViewModel.cs` — heat 0.92, 45 commits (7 fixes), 51 dependents
- `src/Lightbox.App/Views/MainWindow.axaml.cs` — heat 0.61, 38 commits (7 fixes), 2 dependents
- `src/Lightbox.App/Views/MainWindow.axaml` — heat 0.54, 40 commits (5 fixes), 0 dependents
- `src/Lightbox.App/Rendering/CanvasControl.cs` — heat 0.43, 23 commits (5 fixes), 6 dependents
...
- `src/Lightbox.Core/Documents/Scene.cs` — heat 0.21, 9 commits (2 fixes), 17 dependents
- `src/Lightbox.App/Rendering/SceneRenderer.cs` — heat 0.20, 12 commits (2 fixes), 7 dependents

## Substantial files with no test reference

- `src/Lightbox.App/Views/MainWindow.axaml` (2183 ln)
