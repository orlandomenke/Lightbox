...
/// <summary>
/// The enumeration of features that can have defaults per project type. Each
/// feature is reachable in every project type; a type only sets the default,
/// never the availability.
///
/// Adding a feature means:
/// 1. Add the key here
/// 2. Update <see cref="FeatureDefaults"/> constructor with the default for each type
/// 3. Add a test to <see cref="FeatureDefaultsTests"/>
/// </summary>
