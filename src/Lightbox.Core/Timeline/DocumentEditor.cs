...
public sealed class DocumentEditor
{
    ...
    /// and thumbnails alone instead of dropping every one of them (B199).
    /// <para>
    ...
    /// re-flagged a layer — without altering any drawing. B199: this is the
    ...
    private interface IEditStep
    {
        ...
        /// <summary>This step altered no drawing — structure only (B199).</summary>
