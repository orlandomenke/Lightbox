    ...
    private Services.RenderReport.Facts RenderFacts()
    {
        ...
        return new Services.RenderReport.Facts(
            ...
            (_vm.StampRestoreMs.MedianMs, _vm.StampSettledMs.MedianMs, _vm.StampBackupMs.MedianMs,
             ...
             _vm.StampColourMs.MedianMs, _vm.StampFootprintMs.MedianMs,
             _vm.LiveFootprintScaleUsed,
             _vm.LiveSettleTolerance, _vm.LiveSettledEarly.MedianMs),
            _vm.SlowBuildLog,
            _vm.StallCensus,
            _vm.PreviewGaps,
            ...
            (_vm.LiveStampSettled.MedianMs, _vm.LiveStampSettled.PercentileMs(0.9),
             ...
             _vm.LiveStampWholeMarkEvents,
             _vm.LiveBandAtQueue.MedianMs, _vm.LiveBandAtStart.MedianMs,
             _vm.LiveBandAtStart.Count),
            ...
            (_vm.CycleTally.MedianMs, _vm.CycleTally.MeanMs, _vm.CycleTally.Count,
             ...
             _vm.RequestsRefusedByDam, _vm.RequestsRefusedByPost,
             _vm.RequestsRefusedByBoth, _vm.RequestsLetThrough,
             _vm.AskedToPublishTally.MedianMs, _vm.AskedToPublishTally.MeanMs,
             _vm.AskedToPublishTally.WorstMs),
