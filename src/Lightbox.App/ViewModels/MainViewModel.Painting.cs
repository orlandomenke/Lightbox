...
public partial class MainViewModel
{
    ...
    /// pushed, or null when it did not have to key anything (B237).
    /// </summary>
    ...
    private Frame? PaintTargetOrKey()
    {
        ...
        // B237: remembered so a gesture that turns out to have changed nothing
    ...
    public void EndStroke()
    {
        ...
        // B237: an erasure is measured across the append, because the only
